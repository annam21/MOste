...
dat_raw <- readRDS("data/clean/CleanDatabaseDeerF18.RDS")
...
deploy_raw <- read.csv("data/deploy/Cams_Fall18.csv", stringsAsFactors = F) #%>%
...
study_dates <- as.POSIXct(c("2018-9-01 00:00:00", "2018-11-30 23:59:59"), tz = "GMT")
